...
public class EditUserRequestDTO {
        ...
        @NotEmpty(message = "Please enter your original password!") String originalPassword;
        ...
        public @Email(message = AppServiceErrors.EMAIL_FIELD_NOT_VALID) @NotNull(message = "Please enter a valid " +
                "email address!") @NotBlank(message = "Please enter a valid email address!") String email() {
                return email;
        }

        public @NotNull(message = "Please enter your original password!") @NotEmpty(message = "Please enter your " +
                "original password!") String originalPassword() {
                return originalPassword;
        }

        public @NotNull(message = "Please enter a valid password!") @NotEmpty(message = "Please enter a valid " +
                "password!") @Size(min = 3, message = AppServiceErrors.SHORT_PASSWORD) String password() {
                return password;
        }
        ...
        public @NotNull(message = "Please enter your display name!") @NotBlank(message = "Please enter your display " +
                ...
                "characters") @Size(max = 20, message = "Display name could not be longer than 20 characters") String username() {
                return username;
        }
